...
import pragma.users.infraestructure.configuration.security.CustomUsersDetailsService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (StringUtils.hasText(token) && jwtGenerator.validateToken(token)) {
            ...
            if (userRoles.contains("USER") || userRoles.contains("ADMIN") || userRoles.contains("AUX_BODEGA")) {                /*Creamos el objeto UsernamePasswordAuthenticationToken el cual contendrá los detalles de autenticación del usuario*/
